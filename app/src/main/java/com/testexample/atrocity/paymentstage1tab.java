...
import android.view.View;
    ...
    public class paymentstage1tab extends AppCompatActivity {

        @Override
        protected void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            setContentView(R.layout.fragment_paymentstage1tab);
            Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
            setSupportActionBar(toolbar);

            // Get the ViewPager and set it's PagerAdapter so that it can display items
            final ViewPager viewPager = (ViewPager) findViewById(R.id.viewpager);
            viewPager.setAdapter(new MainFragmentPagerAdapter2(getSupportFragmentManager(),
                    paymentstage1tab.this));
            ...
            fab_download.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    //setClickFabMain();
                    startActivity(new Intent(paymentstage1tab.this,Fakeform.class));
                }
            });
            ...
            fab_browser.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    //setClickFabMain();
                    startActivity(new Intent(paymentstage1tab.this,PoliceStationList.class));
