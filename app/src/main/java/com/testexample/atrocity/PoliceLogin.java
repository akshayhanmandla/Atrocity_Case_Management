...
String name1,email;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user != null){
        finish();
        startActivity(new Intent(PoliceLogin.this, UserProfile.class));
        }
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(username.length() != 0 && password.length() != 0) {
                    ...
                    Toast.makeText(PoliceLogin.this, "Login Failed", Toast.LENGTH_SHORT).show();
        ...
        btnLinkToRegisterScreen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent1 = new Intent(PoliceLogin.this,PoliceReg.class);
        ...
        firebaseAuth.signInWithEmailAndPassword(userEmail, userPassword).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    progressDialog.dismiss();
                    Toast.makeText(PoliceLogin.this, "Login Successfull", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(PoliceLogin.this, UserProfile.class));
                } else {
                    Toast.makeText(PoliceLogin.this, "Login Failed", Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
