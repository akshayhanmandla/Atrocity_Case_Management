...
public class Sjsaui extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_sjsaui);
        CardView ME,FM,TM,LL;
        final CardView car3dView;
        ...
        ME.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Sjsaui.this,Sjsastages.class);
        ...
        FM.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //          setToggleEvent(mainGrid);
                Intent intent = new Intent(Sjsaui.this,DistrictView.class);
                startActivity(intent);
        ...
        LL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //            setToggleEvent(mainGrid);
                Intent intent = new Intent(Sjsaui.this,paymentfakeorcomplete.class);
                startActivity(intent);
        ...
        TM.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //              setToggleEvent(mainGrid);
                Intent intent = new Intent(Sjsaui.this,Feedbackui.class);
                startActivity(intent);
