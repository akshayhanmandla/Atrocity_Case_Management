...
public class paymentfakeorcomplete extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fragment_paymentfakeorcomplete);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        // Get the ViewPager and set it's PagerAdapter so that it can display items
        final ViewPager viewPager = (ViewPager) findViewById(R.id.viewpager);
        viewPager.setAdapter(new MainFragmentPagerAdapter4(getSupportFragmentManager(),
                paymentfakeorcomplete.this));
        ...
        fab_download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //setClickFabMain();
                startActivity(new Intent(paymentfakeorcomplete.this,Fakeform.class));
            }
        });
        ...
        fab_browser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //setClickFabMain();
                startActivity(new Intent(paymentfakeorcomplete.this,PoliceStationList.class));
