     ...
     //   tabLayout.setupWithViewPager(viewPager);
        ...
        fab_download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //setClickFabMain();
                startActivity(new Intent(Userui.this,StatusFir.class));
            }
        });
        ...
        fab_browser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //setClickFabMain();
                startActivity(new Intent(Userui.this,Moreinfo.class));
        ...
        fab_map.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //viewPager.setCurrentItem(2);
                //setClickFabMain();
                startActivity(new Intent(Userui.this,MapsActivity.class));
