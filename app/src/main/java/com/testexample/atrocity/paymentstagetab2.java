...
public class paymentstagetab2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new MainFragmentPagerAdapter3(getSupportFragmentManager(),
                paymentstagetab2.this));
        ...
        fab_download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //setClickFabMain();
                startActivity(new Intent(paymentstagetab2.this,Fakeform.class));
            }
        });
        ...
        fab_browser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //setClickFabMain();
                startActivity(new Intent(paymentstagetab2.this,PoliceStationList.class));
